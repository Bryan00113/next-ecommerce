...
export const Hero = () => {
  return (
    //  h-[928px] hero:h-[1024px]  mdHero:h-[978px]
    <section className="relative px-3 overflow-hidden  h-[864px] ">
      ...
      <Image
        // mt-16 md:mt-0
        className="absolute  translate-y-[30%] translate-x-[35%]  pointer-events-none -z-10 max-w-none mix-blend-lighten "
      ...
      <Image
        // mt-16 md:mt-0
        className="absolute  translate-y-[30%] translate-x-[30%]  pointer-events-none -z-10 max-w-none mix-blend-lighten "
        src="/hero-illustration2.svg"
        priority
        alt="Hero illustration"
        aria-hidden="true"
      ...
      <Image
        // mt-16 md:mt-0
        className="absolute  translate-y-[35%] translate-x-[25%]  pointer-events-none -z-10 max-w-none mix-blend-lighten "
        src="/hero-illustration2.svg"
        priority
        alt="Hero illustration"
        aria-hidden="true"
      ...
      <div className="max-w-7xl mx-auto  ">
        <div className="pt-8  md:pb-20 ">
          {/* Hero content */}
          <div className="relative h-full w-full max-w-xl mx-auto md:max-w-none text-center md:text-left">
            {/* Content */}
            <div className="md:w-[600px] mb-8">
              {/* Copy */}
